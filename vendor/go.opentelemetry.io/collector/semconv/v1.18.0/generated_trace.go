...
const (
    ...
    // Requirement Level: Optional
    // Stability: stable
    AttributeMessagingDestinationKind = "messaging.destination.kind"
...
const (
    ...
    // the broker.
    AttributeMessagingSourceName = "messaging.source.name"
    // The kind of message source
    //
    // Type: Enum
    // Requirement Level: Optional
    // Stability: stable
    AttributeMessagingSourceKind = "messaging.source.kind"
    ...
    AttributeMessagingSourceTemplate = "messaging.source.template"
    ...
    // Requirement Level: Optional
    // Stability: stable
    AttributeMessagingSourceTemporary = "messaging.source.temporary"
    ...
    // Requirement Level: Optional
    // Stability: stable
    AttributeMessagingSourceAnonymous = "messaging.source.anonymous"
)

const (
    // A message received from a queue
    AttributeMessagingSourceKindQueue = "queue"
    // A message received from a topic
    AttributeMessagingSourceKindTopic = "topic"
)
...
const (
    ...
    // present, or only messaging.kafka.consumer.group. For brokers, such as RabbitMQ
    ...
    AttributeMessagingConsumerID = "messaging.consumer.id"
)
...
const (
    ...
    // Stability: stable
    // Examples: 2
    AttributeMessagingKafkaSourcePartition = "messaging.kafka.source.partition"
...
func GetTraceSemanticConventionAttributeNames() []string {
    return []string{
        ...
        AttributeMessagingSourceName,
        AttributeMessagingSourceKind,
        AttributeMessagingSourceTemplate,
        AttributeMessagingSourceTemporary,
        AttributeMessagingSourceAnonymous,
        ...
        AttributeMessagingKafkaSourcePartition,
