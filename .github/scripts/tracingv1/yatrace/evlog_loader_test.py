...
from scripts.tracingv1.yatrace.evlog_loader import (
...
def test_malformed_evlog_json_warns_once_with_bounded_example(
    ...
    with caplog.at_level(
        logging.WARNING, logger="scripts.tracingv1.yatrace.evlog_loader"
    ):
    ...
    records = [
        ...
        if record.name == "scripts.tracingv1.yatrace.evlog_loader"
    ]
