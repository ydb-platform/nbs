...
import scripts.tracingv1.ya_trace_report as ya_trace_report_module
import scripts.tracingv1.yatrace.limits as yatrace_limits
...
from scripts.tracingv1.yatrace import (
    ClassifiedNode,
    TestChunk,
    YaCriticalPathEntry,
    YaEvent,
