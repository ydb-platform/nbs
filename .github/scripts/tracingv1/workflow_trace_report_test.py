...
from scripts.tracingv1.workflow_trace import (
    _bounded_times,
    _parent_job,
    build_workflow_trace,
    timestamp_ns,
)
from scripts.tracingv1.workflow_trace_report import download_s3_trace_inputs
...
def test_s3_trace_discovery_accepts_an_empty_prefix(
    ...
    monkeypatch.setattr(
        "scripts.tracingv1.workflow_trace_report.subprocess.run",
        fake_run,
    )
    assert (
