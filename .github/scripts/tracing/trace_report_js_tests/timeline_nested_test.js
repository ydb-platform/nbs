...
function testChunkDescendantsUseTheChunkAsTheirTimeline() {
  ...
  const stage = timelineBarGeometry(
    3,
    spans,
    scopes,
    traceDuration,
  ...
  const directStage = timelineBarGeometry(
    4,
    spans,
    scopes,
    traceDuration,
  ...
  const test = timelineBarGeometry(
    5,
    spans,
    scopes,
    traceDuration,
  ...
  const workerPhase = timelineBarGeometry(
    6,
    spans,
    scopes,
    traceDuration,
...
function testNearestChunkWinsAndLocalIntervalsAreClipped() {
  ...
  assert.deepStrictEqual(localGeometry(3), {
    left: 25,
    width: 25,
    relativeTo: 2,
  });
  assert.deepStrictEqual(localGeometry(4), {
    left: 75,
    width: 25,
    relativeTo: 2,
  });
  assert.deepStrictEqual(localGeometry(5), {
    left: 100,
    width: 0,
    relativeTo: 2,
  });
  assert.deepStrictEqual(localGeometry(6), {
    left: 25,
    width: 0.15,
    relativeTo: 2,
  });
  assert.deepStrictEqual(localGeometry(7), {
    left: 99.85,
    width: 0.15,
    relativeTo: 2,
  });
  assert.deepStrictEqual(localGeometry(8), {
    left: 99.85,
    width: 0.15,
    relativeTo: 2,
  });
