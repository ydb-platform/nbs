...
while [ "$#" -gt 0 ]; do
    case "$1" in
        ...
        --ya-out) ya_out=${2:-}; shift 2 ;;
        --evlog) evlog=${2:-}; shift 2 ;;
        --warning-title) warning_title=${2:-}; shift 2 ;;
        --html-url) html_url=${2:-}; shift 2 ;;
        --otlp-url) otlp_url=${2:-}; shift 2 ;;
        --inputs-url) inputs_url=${2:-}; shift 2 ;;
        --summary) summary=${2:-}; shift 2 ;;
        --summary-heading) summary_heading=${2:-}; shift 2 ;;
