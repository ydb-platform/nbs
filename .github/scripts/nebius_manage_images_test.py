...
def test_select_images_to_remove_keeps_requested_count():
    candidate_images = [
        make_image("remove-1", created_at="2026-04-22T10:00:00Z"),
        make_image("keep-1", created_at="2026-04-25T10:00:00Z"),
        make_image("remove-2", created_at="2026-04-21T10:00:00Z"),
        make_image("keep-2", created_at="2026-04-24T10:00:00Z"),
    ]
...
def test_main_updates_variable_and_removes_old_images():
    ...
    class FakeImageService:
        ...
        async def list(self, request):
            ...
            return SimpleNamespace(
                items=[
                    make_image("new-image", created_at="2026-04-26T10:00:00Z"),
                    make_image("remove-image", created_at="2026-04-23T10:00:00Z"),
                    make_image("keep-image", created_at="2026-04-25T10:00:00Z"),
                ],
                next_page_token="",
            )
