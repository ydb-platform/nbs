import contrib.ydb.core.protos.blobstorage_config_pb2 as kikimr_bsconfig
import contrib.ydb.core.protos.blobstorage_disk_color_pb2 as kikimr_disk_color
import contrib.ydb.apps.dstool.lib.common as common
import contrib.ydb.apps.dstool.lib.table as table
