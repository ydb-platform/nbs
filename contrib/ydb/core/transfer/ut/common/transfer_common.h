...
void MessageField_Attributes(const std::string& tableType, bool local = false);
void MessageField_CreateTimestamp(const std::string& tableType, bool local = false);
void MessageField_MessageGroupId(const std::string& tableType);
void MessageField_Partition(const std::string& tableType, bool local = false);
void MessageField_ProducerId(const std::string& tableType);
void MessageField_SeqNo(const std::string& tableType);
void MessageField_WriteTimestamp(const std::string& tableType, bool local = false);
