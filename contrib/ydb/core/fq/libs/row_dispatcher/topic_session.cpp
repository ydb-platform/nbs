...
#include <contrib/ydb/core/fq/libs/metrics/sanitize_label.h>
#include <contrib/ydb/core/fq/libs/row_dispatcher/events/data_plane.h>
#include <contrib/ydb/core/fq/libs/row_dispatcher/format_handler/format_handler.h>
...
void TTopicSession::Handle(NFq::TEvPrivate::TEvGetEventByTimerEvent::TPtr&) {
    LOG_ROW_DISPATCHER_TRACE("TEvGetEventByTimerEvent");
