...
#include <contrib/ydb/core/http_proxy/auth_actors.h>
...
NJson::TJsonValue THttpProxyTestMock::CreateDeleteStreamRequest() {
    NJson::TJsonValue record;
    record["StreamName"] = "testtopic";
    return record;
}

NJson::TJsonValue THttpProxyTestMock::CreateDescribeStreamRequest() {
    NJson::TJsonValue record;
    record["StreamName"] = "testtopic";
    return record;
}

NJson::TJsonValue THttpProxyTestMock::CreateDescribeStreamSummaryRequest() {
    NJson::TJsonValue record;
    record["StreamName"] = "testtopic";
    return record;
}

NJson::TJsonValue THttpProxyTestMock::CreatePutRecordsRequest() {
    NJson::TJsonValue record;
    record["StreamName"] = "testtopic";
...
NJson::TJsonValue THttpProxyTestMock::CreateRegisterStreamConsumerRequest() {
    NJson::TJsonValue record;
    record["StreamArn"] = "";
    record["ConsumerName"] = "";
    return record;
...
NJson::TJsonValue THttpProxyTestMock::CreateDeregisterStreamConsumerRequest() {
    NJson::TJsonValue record;
    record["StreamArn"] = "";
    record["ConsumerName"] = "";
    return record;
...
NJson::TJsonValue THttpProxyTestMock::CreateListStreamConsumersRequest() {
    NJson::TJsonValue record;
...
NJson::TJsonValue THttpProxyTestMock::CreateGetShardIteratorRequest() {
    NJson::TJsonValue record;
    record["StreamName"] = "testtopic";
...
NJson::TJsonValue THttpProxyTestMock::CreateGetRecordsRequest() {
    NJson::TJsonValue record;
...
NJson::TJsonValue THttpProxyTestMock::CreateListShardsRequest() {
    NJson::TJsonValue record;
    record["MaxResults"] = 100;
...
NJson::TJsonValue THttpProxyTestMock::CreateSqsGetQueueUrlRequest() {
    NJson::TJsonValue record;
    record["QueueName"] = "ExampleQueueName";
    return record;
}

NJson::TJsonValue THttpProxyTestMock::CreateSqsCreateQueueRequest() {
    NJson::TJsonValue record;
    record["QueueName"] = "ExampleQueueName";
    return record;
}
...
void THttpProxyTestMock::WaitQueueAttributes(TString queueUrl, size_t retries, std::function<bool (NJson::TJsonMap json)> predicate) {
...
TMaybe<NYdb::TResultSet> THttpProxyTestMock::RunYqlDataQuery(TString query) {
