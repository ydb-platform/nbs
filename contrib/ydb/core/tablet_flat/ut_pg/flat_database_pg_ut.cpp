...
#include <contrib/ydb/core/tablet_flat/test/libs/table/test_dbase.h>
...
Y_UNIT_TEST_SUITE(TFlatDatabasePgTest) {
    ...
    Y_UNIT_TEST(BasicTypes) {
        ...
        db->Alter()
            ...
            .AddColumnWithTypeInfo(tableId, "boolean", IdBool, NScheme::NTypeIds::Pg, makePgTypeInfo(BOOLOID), false, false)
            .AddColumnWithTypeInfo(tableId, "char", IdChar, NScheme::NTypeIds::Pg, makePgTypeInfo(CHAROID), false, false)
            .AddColumnWithTypeInfo(tableId, "int2", IdInt2, NScheme::NTypeIds::Pg, makePgTypeInfo(INT2OID), false, false)
            .AddColumnWithTypeInfo(tableId, "int4", IdInt4, NScheme::NTypeIds::Pg, makePgTypeInfo(INT4OID), false, false)
            .AddColumnWithTypeInfo(tableId, "int8", IdInt8, NScheme::NTypeIds::Pg, makePgTypeInfo(INT8OID), false, false)
            .AddColumnWithTypeInfo(tableId, "float4", IdFloat4, NScheme::NTypeIds::Pg, makePgTypeInfo(FLOAT4OID), false, false)
            .AddColumnWithTypeInfo(tableId, "float8", IdFloat8, NScheme::NTypeIds::Pg, makePgTypeInfo(FLOAT8OID), false, false)
            .AddColumnWithTypeInfo(tableId, "text", IdText, NScheme::NTypeIds::Pg, makePgTypeInfo(TEXTOID), false, false)
            .AddColumnWithTypeInfo(tableId, "bytea", IdBytea, NScheme::NTypeIds::Pg, makePgTypeInfo(BYTEAOID), false, false)
            .AddColumnWithTypeInfo(tableId, "bpchar", IdBpchar, NScheme::NTypeIds::Pg, makePgTypeInfo(BPCHAROID), false, false)
