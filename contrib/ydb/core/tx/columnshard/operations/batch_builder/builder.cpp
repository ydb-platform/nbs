...
#include <contrib/ydb/core/tx/columnshard/engines/writer/buffer/events.h>
#include <contrib/ydb/core/tx/columnshard/engines/writer/indexed_blob_constructor.h>
#include <contrib/ydb/core/tx/columnshard/operations/slice_builder/builder.h>
...
void TBuildBatchesTask::DoExecute(const std::shared_ptr<ITask>& /*taskPtr*/) {
    YDB_LOG_CREATE_CONTEXT(
        {"scope", "TBuildBatchesTask::DoExecute"});
    if (!Context.IsActive()) {
