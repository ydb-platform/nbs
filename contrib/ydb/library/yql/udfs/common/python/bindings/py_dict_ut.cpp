...
Y_UNIT_TEST(ToPyDict) {
    ...
    engine.ToPython<NUdf::TDict<int, double>>(
        [](const TType* type, const NUdf::IValueBuilder& vb) {
            return vb.NewDict(type, NUdf::TDictFlags::Hashed)->Add(NUdf::TUnboxedValuePod((int)1), NUdf::TUnboxedValuePod((double)0.1)).Add(NUdf::TUnboxedValuePod((int)2), NUdf::TUnboxedValuePod((double)0.2)).Add(NUdf::TUnboxedValuePod((int)3), NUdf::TUnboxedValuePod((double)0.3)).Build();
        },
        "def Test(value):\n"
        "    assert value\n"
        "    assert len(value) == 3\n"
...
Y_UNIT_TEST(ToPySet) {
    ...
    engine.ToPython<NUdf::TDict<ui8, void>>(
        [](const TType* type, const NUdf::IValueBuilder& vb) {
            return vb.NewDict(type, NUdf::TDictFlags::Hashed)->Add(NUdf::TUnboxedValuePod((ui8)1), NUdf::TUnboxedValuePod::Void()).Add(NUdf::TUnboxedValuePod((ui8)2), NUdf::TUnboxedValuePod::Void()).Add(NUdf::TUnboxedValuePod((ui8)3), NUdf::TUnboxedValuePod::Void()).Build();
        },
        "def Test(value):\n"
        "    assert len(value) == 3\n"
...
Y_UNIT_TEST(ToPyMultiDict) {
    ...
    engine.ToPython<NUdf::TDict<ui8, NUdf::TListType<NUdf::TUtf8>>>(
        [](const TType* type, const NUdf::IValueBuilder& vb) {
            ...
            return vb.NewDict(type, flags)->Add(NUdf::TUnboxedValuePod((ui8)1), vb.NewString("one")).Add(NUdf::TUnboxedValuePod((ui8)1), vb.NewString("two")).Add(NUdf::TUnboxedValuePod((ui8)3), vb.NewString("three")).Build();
        },
        "def Test(value):\n"
        "    assert len(value) == 2\n"
        "    assert 1 in value\n"
...
Y_UNIT_TEST(ToPyAndBackDictAsIs) {
    ...
    engine.ToPythonAndBack<NUdf::TDict<i32, double>>(
        [](const TType* type, const NUdf::IValueBuilder& vb) {
            return vb.NewDict(type, NUdf::TDictFlags::Sorted)->Add(NUdf::TUnboxedValuePod((i32)1), NUdf::TUnboxedValuePod((double)0.1)).Add(NUdf::TUnboxedValuePod((i32)2), NUdf::TUnboxedValuePod((double)0.2)).Add(NUdf::TUnboxedValuePod((i32)3), NUdf::TUnboxedValuePod((double)0.3)).Build();
        },
...
Y_UNIT_TEST(PyInvertDict) {
    ...
    engine.ToPythonAndBack<NUdf::TDict<i32, double>, NUdf::TDict<double, i32>>(
        [](const TType* type, const NUdf::IValueBuilder& vb) {
            return vb.NewDict(type, NUdf::TDictFlags::Hashed)->Add(NUdf::TUnboxedValuePod((i32)1), NUdf::TUnboxedValuePod((double)0.1)).Add(NUdf::TUnboxedValuePod((i32)2), NUdf::TUnboxedValuePod((double)0.2)).Add(NUdf::TUnboxedValuePod((i32)3), NUdf::TUnboxedValuePod((double)0.3)).Build();
        },
