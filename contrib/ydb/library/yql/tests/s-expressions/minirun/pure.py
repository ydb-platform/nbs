...
MINIRUN_PATH = yql_binary_path('contrib/ydb/library/yql/tools/minirun/minirun')
DATA_PATH = yatest.common.source_path('contrib/ydb/library/yql/tests/s-expressions/suites')
...
def run_test(suite, case, cfg, tmpdir, what, yql_http_file_server):
    ...
    if what == 'RunOnOpt' or what == 'LLVM' or what == 'PartialTypeCheck':
        ...
        yqlrun = YQLRun(
            ...
            udfs_dir=yql_binary_path('contrib/ydb/library/yql/tests/common/test_framework/udfs_deps'),
            binary=MINIRUN_PATH,
            langver=langver,
