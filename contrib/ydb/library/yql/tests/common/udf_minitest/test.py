...
MINIRUN_PATH = yql_utils.yql_binary_path(os.getenv('YQL_MINIRUN_PATH') or 'contrib/ydb/library/yql/tools/minirun/minirun')
CFG_DIR = os.getenv('YQL_CONFIG_DIR') or 'contrib/ydb/library/yql/cfg/tests'
