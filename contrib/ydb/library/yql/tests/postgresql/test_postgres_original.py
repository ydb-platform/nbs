...
PGRUN = yatest.common.binary_path('contrib/ydb/library/yql/tools/pgrun/pgrun')
UDFS = [
    yatest.common.binary_path('contrib/ydb/library/yql/udfs/common/set/libset_udf.so'),
    yatest.common.binary_path('contrib/ydb/library/yql/udfs/common/re2/libre2_udf.so'),
]
