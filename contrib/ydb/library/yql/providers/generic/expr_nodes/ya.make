...
IF (EXPORT_CMAKE)
    RUN_PYTHON3(
        ${ARCADIA_ROOT}/contrib/ydb/library/yql/core/expr_nodes_gen/gen/__main__.py yql_expr_nodes_gen.jnj
        ...
        OUTPUT_INCLUDES ${ARCADIA_ROOT}/contrib/ydb/library/yql/core/expr_nodes_gen/yql_expr_nodes_gen.h
            ${ARCADIA_ROOT}/util/generic/hash_set.h
    )
ELSE()
    RUN_PROGRAM(
        contrib/ydb/library/yql/core/expr_nodes_gen/gen yql_expr_nodes_gen.jnj yql_generic_expr_nodes.json
