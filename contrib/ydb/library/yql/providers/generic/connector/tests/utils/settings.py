...
from contrib.ydb.library.yql.providers.generic.connector.tests.utils.docker_compose import EndpointDeterminer
...
class Settings:
    ...
    def from_env(cls) -> 'Settings':
        docker_compose_file = yatest.common.source_path(
            'contrib/ydb/library/yql/providers/generic/connector/tests/docker-compose.yml'
        )
