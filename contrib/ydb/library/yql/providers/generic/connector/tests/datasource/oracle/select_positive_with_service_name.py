...
import contrib.ydb.library.yql.providers.generic.connector.tests.utils.types.oracle as oracle
...
from contrib.ydb.library.yql.providers.generic.connector.tests.common_test_cases.base import BaseTestCase
