...
from contrib.ydb.library.yql.providers.generic.connector.api.common.data_source_pb2 import EProtocol
...
from contrib.ydb.library.yql.providers.generic.connector.tests.utils.runner import Result, Runner
