        ...
        pgmBuilder.FromFlow(pgmBuilder.FlatMap(
            ...
            [&](TRuntimeNode list) { return pgmBuilder.StableSort(list,
                                                                  [&](TRuntimeNode left, TRuntimeNode right) {
                                                                      return pgmBuilder.Or({pgmBuilder.AggrLess(pgmBuilder.Member(left, "a"), pgmBuilder.Member(right, "a")),
                                                                                            pgmBuilder.And({pgmBuilder.AggrEquals(pgmBuilder.Member(left, "a"), pgmBuilder.Member(right, "a")),
