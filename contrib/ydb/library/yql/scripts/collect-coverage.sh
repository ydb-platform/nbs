...
# in contrib/ydb/library/yql/core (i.e. type annotation machinery, optimizers)
...
# /contrib/ydb/library/yql/core/ by the minirun test suite.
...
ya make -tA                                                    \
    -C ${ARC_ROOT}/contrib/ydb/library/yql/tests/sql/minirun            \
    -C ${ARC_ROOT}/contrib/ydb/library/yql/tests/s-expressions/minirun  \
