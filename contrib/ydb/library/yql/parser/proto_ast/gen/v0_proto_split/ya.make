...
SET(sql_grammar ${ARCADIA_ROOT}/contrib/ydb/library/yql/sql/v0/SQL.g)

SET(ANTLR_PACKAGE_NAME NSQLGenerated)

CONFIGURE_FILE(${ARCADIA_ROOT}/contrib/ydb/library/yql/parser/proto_ast/org/antlr/codegen/templates/protobuf/protobuf.stg.in ${antlr_templates}/protobuf/protobuf.stg)
...
RUN_PYTHON3(
    ${ARCADIA_ROOT}/contrib/ydb/library/yql/parser/proto_ast/gen/multiproto.py SQLParser
    IN SQLParser.pb.h
    IN SQLParser.pb.cc
    OUT_NOAUTO
    ...
    SQLParser.pb.main.h
    CWD $ARCADIA_BUILD_ROOT/contrib/ydb/library/yql/parser/proto_ast/gen/v0_proto_split
)
