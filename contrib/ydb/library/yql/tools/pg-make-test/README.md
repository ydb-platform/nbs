...
from Postgres' regression tests located in contrib/ydb/library/yql/tests/postgresql/original/cases.
The extracted tests are normally saved into contrib/ydb/library/yql/tests/postgresql/cases.
