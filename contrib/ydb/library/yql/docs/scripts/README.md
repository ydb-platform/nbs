...
```bash
./contrib/ydb/library/yql/docs/scripts/doc_upgrade_arc.sh <dst_path>/<src.cfg> <doc_source_dir>
```
...
```bash
./contrib/ydb/library/yql/docs/scripts/doc_upgrade_arc.sh yql/docs_yfm/docs/ru/essentials.base_rev contrib/ydb/library/yql/docs/ru
```

В примере выше путем-источником для документации в yql/docs_yfm/docs/ru будет contrib/ydb/library/yql/docs/ru.

Аналогичный скрипт для git-репозитория находится по пути `contrib/ydb/library/yql/docs/scripts/doc_upgrade_git.sh`

### Обновление документации

```bash
./contrib/ydb/library/yql/docs/scripts/doc_upgrade_arc.sh <dst_path>/<src.cfg>
```
