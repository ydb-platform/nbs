...
class Runner:
    DEPS = {
        ...
        "dqrun" : "contrib/ydb/library/yql/tools/dqrun",
    ...
    DATA = {
        "fs-cfg" : "contrib/ydb/library/yql/tools/dqrun/examples/fs.conf",
...
def upload(result_path, s3_folder, try_num):
    uploader = pathlib.Path(yatest.common.source_path("contrib/ydb/library/benchmarks/runner/upload_results.py")).resolve()
