...
namespace NInterconnect {
    ...
    public:
        ...
        public:
            ...
            /*
             * Set or update external handler id. For example sequence number of
             * successful MSG_ZEROCOPY call Should not be called in period
             * between MakeBuffersShared and before CompleteSharedBuffers call
             */
