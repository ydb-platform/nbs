...
KQPRUN_PATH = os.getenv("KQPRUN_EXECUTABLE") or "contrib/ydb/tests/tools/kqprun/kqprun"
...
def build_start_comand(argv: list[str], grpc_port: int) -> tuple[int, list[str]]:
    ...
    parser.add_argument("--config", action='store', type=str, default="contrib/ydb/tests/tools/kqprun/kqprun/configuration/app_config.conf")
