...
import grpc
from contrib.ydb.library.yql.providers.common.token_accessor.grpc.token_accessor_pb_pb2_grpc import (
    TokenAccessorServiceServicer,
    add_TokenAccessorServiceServicer_to_server,
)
from contrib.ydb.library.yql.providers.common.token_accessor.grpc.token_accessor_pb_pb2 import GetTokenRequest, GetTokenResponse
