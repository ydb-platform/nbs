...
import pytest
import random
from contrib.ydb.tests.olap.column_compression.common.base import ColumnTestBase
from contrib.ydb.tests.library.common.helpers import plain_or_under_sanitizer
from contrib.ydb.tests.olap.common.column_table_helper import ColumnTableHelper
from contrib.ydb.tests.library.common.protobuf_ss import SchemeDescribeRequest
...
class TestCreateWithColumnCompression(TestCompressionBase):
    ...
    def test_add_with_compression(self, suffix, compression_settings, codec_id):
        ...
        response = self.cluster.client.send(SchemeDescribeRequest(self.table_path).protobuf, 'SchemeDescribe')
