...
class WorkloadLogBase(WorkloadTestBase):
    workload_binary_name = 'workload_log'
    workload_env_var = 'LOG_WORKLOAD_BINARY'
    ...
    def test_workload_log(self, nemesis_enabled: bool, store_type: str):
        ...
        additional_stats = {
            "workload_type": "log",
            "log_template": "workload_log_{node_host}_iter_{iteration_num}_{uuid}",
...
class TestWorkloadLog(WorkloadLogBase):
