...
from contrib.ydb.tests.olap.lib.remote_execution import (
    execute_command,
    deploy_binaries_to_hosts,
    copy_file,
)
from contrib.ydb.tests.olap.lib.ydb_cli import YdbCliHelper
from contrib.ydb.tests.olap.lib.results_processor import ResultsProcessor
from contrib.ydb.tests.olap.lib.utils import external_param_is_true, get_external_param

# Импортируем LoadSuiteBase чтобы наследоваться от него
from contrib.ydb.tests.olap.load.lib.conftest import LoadSuiteBase
        ...
        try:
            ...
            if enable_nemesis:
                ...
                if nemesis_binary_path:
                    ...
                    nemesis_binary = yatest.common.binary_path(
                        "contrib/ydb/tests/tools/nemesis/driver/nemesis"
                    )
