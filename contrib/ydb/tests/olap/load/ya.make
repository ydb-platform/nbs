PY3TEST()
    ...
    ENV(OLAP_WORKLOAD_BINARY="contrib/ydb/tests/stress/olap_workload/olap_workload")
    ENV(TOPIC_WORKLOAD_BINARY="contrib/ydb/tests/stress/topic/workload_topic")
    ENV(LOG_WORKLOAD_BINARY="contrib/ydb/tests/stress/log/workload_log")
    ENV(MIXED_WORKLOAD_BINARY="contrib/ydb/tests/stress/mixedpy/workload_mixed")
    ENV(KV_WORKLOAD_BINARY="contrib/ydb/tests/stress/kv/workload_kv")
    ENV(CTAS_WORKLOAD_BINARY="contrib/ydb/tests/stress/ctas/ctas")
    ENV(KAFKA_WORKLOAD_BINARY="contrib/ydb/tests/stress/kafka/kafka_streams_test")
    ENV(NODE_BROKER_WORKLOAD_BINARY="contrib/ydb/tests/stress/node_broker/node_broker")
    ENV(TOPIC_KAFKA_WORKLOAD_BINARY="contrib/ydb/tests/stress/topic_kafka/workload_topic_kafka")
    ENV(TRANSFER_WORKLOAD_BINARY="contrib/ydb/tests/stress/transfer/transfer")
    ENV(RECONFIG_STATE_STORAGE_WORKLOAD_BINARY="contrib/ydb/tests/stress/reconfig_state_storage_workload/reconfig_state_storage_workload")
    ENV(SHOW_CREATE_WORKLOAD_BINARY="contrib/ydb/tests/stress/show_create/view/show_create_view")
    ENV(CDC_WORKLOAD_BINARY="contrib/ydb/tests/stress/cdc/cdc")
    ENV(STATISTICS_WORKLOAD_BINARY="contrib/ydb/tests/stress/statistics_workload/statistics_workload")
    ENV(NEMESIS_BINARY="contrib/ydb/tests/tools/nemesis/driver/nemesis")
