...
from contrib.ydb.tests.library.compatibility.fixtures import init_stable_binary_path, init_stable_name
from contrib.ydb.tests.library.compatibility.fixtures import inter_stable_binary_path, inter_stable_name
from contrib.ydb.tests.library.compatibility.fixtures import current_binary_path, current_name
