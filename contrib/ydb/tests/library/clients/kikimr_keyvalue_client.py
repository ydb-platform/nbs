...
from contrib.ydb.public.api.grpc import ydb_keyvalue_v1_pb2_grpc as grpc_server
from contrib.ydb.public.api.grpc import ydb_keyvalue_v2_pb2_grpc as grpc_server_v2
from contrib.ydb.public.api.protos import ydb_keyvalue_pb2 as keyvalue_api
