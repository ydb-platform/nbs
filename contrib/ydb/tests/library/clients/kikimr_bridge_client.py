...
from contrib.ydb.public.api.grpc.draft import ydb_bridge_v1_pb2_grpc as grpc_server
from contrib.ydb.public.api.protos.draft import ydb_bridge_pb2 as bridge_api
