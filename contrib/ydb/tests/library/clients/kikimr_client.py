...
from contrib.ydb.tests.library.common.protobuf_ss import TSchemeOperationStatus
...
from contrib.ydb.core.protos import blobstorage_config_pb2
...
from contrib.ydb.public.api.grpc.draft import ydb_tablet_v1_pb2_grpc as grpc_tablet_service
from contrib.ydb.public.api.protos.draft.ydb_tablet_pb2 import RestartTabletRequest
