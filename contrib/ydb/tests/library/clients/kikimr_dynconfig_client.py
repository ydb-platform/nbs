...
from contrib.ydb.public.api.grpc.draft import ydb_dynamic_config_v1_pb2_grpc as grpc_server
from contrib.ydb.public.api.protos.draft import ydb_dynamic_config_pb2 as dynamic_config_api
