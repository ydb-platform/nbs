...
from contrib.ydb.tests.library.stability.utils.collect_errors import create_cluster_issue
from contrib.ydb.tests.library.stability.utils.remote_execution import patch_max_suffix, copy_file, execute_command, deploy_binaries_to_hosts
...
from contrib.ydb.tests.library.stability.utils.results_models import StressUtilDeployResult
    ...
    def _install_nemesis_services(self, nemesis_log: list[str]) -> bool:
        ...
        if nemesis_binary_path:
            ...
            nemesis_binary = yatest.common.binary_path(
                "contrib/ydb/tests/stability/nemesis/nemesis"
            )
