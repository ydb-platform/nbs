...
def _init_stress_utils():
    ...
    _all_stress_utils = {
        'Cdc': {
            ...
            'local_path': 'contrib/ydb/tests/stress/cdc/cdc'
        },
        'Ctas': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--path", "workload_ctas_{node_host}_iter_{iteration_num}_{uuid}"],
            'local_path': 'contrib/ydb/tests/stress/ctas/ctas'
        },
        'Kafka': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     ...
                     "--num-workers", "2"],
            'local_path': 'contrib/ydb/tests/stress/kafka/kafka_streams_test'
        },
        'NodeBroker': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--mon-endpoint", "http://{node_host}:8765",
                     ],
            'local_path': 'contrib/ydb/tests/stress/node_broker/node_broker'
        },
        'Olap': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--path", "olap_workload_{node_host}_iter_{iteration_num}_{uuid}"],
            'local_path': 'contrib/ydb/tests/stress/olap_workload/olap_workload'
        },
        'Oltp': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--path", "oltp_workload_{node_host}_iter_{iteration_num}_{uuid}"],
            'local_path': 'contrib/ydb/tests/stress/oltp_workload/oltp_workload'
        },
        # TODO does not support custom cluster configs
        # 'workload_reconfig_state_storage': {
        #     'args': ,
        #     'local_path': 'contrib/ydb/tests/stress/reconfig_state_storage_workload/reconfig_state_storage_workload'
        # },
        'ShowCreateView': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--path-prefix", "workload_show_create_{node_host}_iter_{iteration_num}_{uuid}"],
            'local_path': 'contrib/ydb/tests/stress/show_create/view/show_create_view'
        },
        'ShowCreateTable': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--path-prefix", "workload_show_create_{node_host}_iter_{iteration_num}_{uuid}"],
            'local_path': 'contrib/ydb/tests/stress/show_create/table/show_create_table'
        },
        'Statistics': {
            'args': ["--host", "{node_host}",
                     "--port", "2135",
                     "--prefix", "statistics_workload_{node_host}_iter_{iteration_num}_{uuid}"],
            'local_path': 'contrib/ydb/tests/stress/statistics_workload/statistics_workload'
        },
        'TopicKafka': {
            'args': [
            ...
            'local_path': 'contrib/ydb/tests/stress/topic_kafka/workload_topic_kafka'
        },
        'Topic': {
            'args': [
                "--endpoint", "grpc://{node_host}:2135",
            ...
            'local_path': 'contrib/ydb/tests/stress/topic/workload_topic'
        },
        'Viewer': {
            'args': [
                "--mon_endpoint", "http://{node_host}:8765",
            ],
            'local_path': 'contrib/ydb/tests/stress/viewer/viewer'
        },
        'TestShard': {
            'args': [
                "--endpoint", "grpc://{node_host}:2135",
            ...
            'local_path': 'contrib/ydb/tests/stress/testshard_workload/workload_testshard',
            'nodes_percentage': 1
        },
        'IncrementalBackup': {
            'args': [
            ...
            'local_path': 'contrib/ydb/tests/stress/backup/backup_stress'
        },
        'Streaming': {
            'args': [
            ...
            'local_path': 'contrib/ydb/tests/stress/streaming/streaming'
        },
        'TopicSqs': {
            'args': [
                "--endpoint", "grpc://{node_host}:2135",
            ...
            'local_path': 'contrib/ydb/tests/stress/topic_sqs/topic_sqs'
        },
        'MinMax': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--path", "min_max_workload_{node_host}_iter_{iteration_num}_{uuid}"],
            'local_path': 'contrib/ydb/tests/stress/min_max_workload/min_max_workload'
        },
        'ResultSetFormat': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--path", "result_set_format_{node_host}_iter_{iteration_num}_{uuid}"],
            'local_path': 'contrib/ydb/tests/stress/result_set_format/result_set_format'
        },
        'SystemTabletBackup': {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--mon-endpoint", "http://{node_host}:8765"],
            'local_path': 'contrib/ydb/tests/stress/system_tablet_backup/system_tablet_backup'
        },
    }
    ...
    for table_type in ['row', 'column']:
        _all_stress_utils[f'Kv_{table_type}'] = {
            ...
            'local_path': 'contrib/ydb/tests/stress/kv/workload_kv'
        }
        _all_stress_utils[f'Log_{table_type}'] = {
            ...
            'local_path': 'contrib/ydb/tests/stress/log/workload_log'
        }
        _all_stress_utils[f'Mixed_{table_type}'] = {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--store_type", table_type,
                     "--mixed_prefix", f"mixed_{table_type}_{{node_host}}_iter_{{iteration_num}}_{{uuid}}"],
            'local_path': 'contrib/ydb/tests/stress/mixedpy/workload_mixed'
        }
        _all_stress_utils[f'SimpleQueue_{table_type}'] = {
            'args': ["--endpoint", "grpc://{node_host}:2135",
                     "--mode", table_type],
            'local_path': 'contrib/ydb/tests/stress/simple_queue/simple_queue'
        }
        for topic_type in ['local', 'remote']:
            _all_stress_utils[f'Transfer_{table_type}_topic_{topic_type}'] = {
                ...
                'local_path': 'contrib/ydb/tests/stress/transfer/transfer'
            }
    ...
    for config_preset in ['common_channel_read', 'inline_channel_read', 'write_read_delete']:
        _all_stress_utils[f'KVVolume_{config_preset}'] = {
            ...
            'local_path': 'contrib/ydb/tests/stress/kv_volume/workload_keyvalue_volume'
        }
