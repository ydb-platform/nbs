...
from contrib.ydb.tests.library.common.composite_assert import CompositeAssert # noqa
from contrib.ydb.tests.library.harness.kikimr_cluster import ExternalKiKiMRCluster # noqa
from contrib.ydb.tests.library.matchers.collection import is_empty # noqa
...
def read_table_profile():
    with open(yatest.common.source_path('contrib/ydb/tests/stability/resources/tbl_profile.txt'), 'r') as reader:
        return reader.read()
...
class TestSetupForStability(object):
    ...
    artifacts = (
        yatest.common.binary_path('contrib/ydb/tests/tools/nemesis/driver/nemesis'),
        yatest.common.binary_path('contrib/ydb/tests/stress/simple_queue/simple_queue'),
        yatest.common.binary_path('contrib/ydb/tests/stress/olap_workload/olap_workload'),
        yatest.common.binary_path('contrib/ydb/tests/stress/statistics_workload'),
    )
