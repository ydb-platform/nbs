...
from contrib.ydb.public.api.grpc.ydb_discovery_v1_pb2_grpc import DiscoveryServiceStub
...
from contrib.ydb.public.api.protos import ydb_discovery_pb2 as discovery
