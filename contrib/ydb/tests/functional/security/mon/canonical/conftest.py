...
from contrib.ydb.tests.functional.security.lib.cluster_config import create_ydb_configurator, generate_certificates

TENANT_DATABASE = '/Root/Tenant'

pytest_plugins = ['contrib.contrib.ydb.tests.library.fixtures', 'contrib.contrib.ydb.tests.library.flavours']
