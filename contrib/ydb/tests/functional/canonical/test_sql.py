...
from contrib.ydb.public.api.protos import ydb_table_pb2
...
class TestCanonicalFolder1(BaseCanonicalTest):
    data_folder = 'contrib/ydb/tests/functional/canonical/sql'
    uniq_idx = 'base'

    @pytest.mark.parametrize(['query_name', 'kind'],
                             get_queries('contrib/ydb/tests/functional/canonical/sql'))
