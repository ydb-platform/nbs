...
ydbd_25_1 = yatest.common.binary_path("contrib/ydb/tests/library/compatibility/ydbd-25-1")
ydbd_24_4 = yatest.common.binary_path("contrib/ydb/tests/library/compatibility/ydbd-24-4")
