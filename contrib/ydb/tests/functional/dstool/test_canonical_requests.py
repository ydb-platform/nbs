...
from contrib.ydb.apps.dstool.main import main as dstool_main
from contrib.ydb.apps.dstool.lib import common
from contrib.ydb.apps.dstool.lib import table
...
from contrib.ydb.core.protos.whiteboard_disk_states_pb2 import EVDiskState
...
class TestBase:
    ...
    def setup(self, ydb_cluster):
        set_canondata_root('contrib/ydb/tests/functional/dstool/canondata')
