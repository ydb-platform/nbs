...
from contrib.ydb.tests.tools.fq_runner.kikimr_utils import yq_all


class TestS3Compressions:
    def create_bucket_and_upload_file(self, filename, s3, kikimr):
        s3_helpers.create_bucket_and_upload_file(filename, s3.s3_url, "fbucket", "contrib/ydb/tests/fq/s3/test_compression_data")
