...
class KqpRun(object):
    def __init__(self, udfs_dir=None):
        self.kqprun_binary = yql_utils.yql_binary_path('contrib/ydb/tests/tools/kqprun/kqprun')

        self.config_file = yql_utils.yql_source_path(os.path.join('contrib/ydb/tests/fq/yt/cfg', 'kqprun_config.conf'))
        self.scheme_file = yql_utils.yql_source_path(os.path.join('contrib/ydb/tests/fq/yt/cfg', 'kqprun_scheme.sql'))
