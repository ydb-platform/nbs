...
from contrib.ydb.tests.fq.streaming_common.common import Kikimr, StreamingTestBase, YdbClient, set_test_env
...
def kikimr_udfs(request):
    ...
    config = KikimrConfigGenerator(
        ...
        udfs_path=yatest.common.build_path("contrib/ydb/library/yql/udfs/common/python/python3_small")
    )
