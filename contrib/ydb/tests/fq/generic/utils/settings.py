...
from contrib.ydb.tests.tools.docker_compose_helpers.endpoint_determiner import EndpointDeterminer
...
class Settings:
    ...
    def from_env(cls) -> 'Settings':
        docker_compose_file = yatest.common.source_path('contrib/ydb/tests/fq/generic/docker-compose.yml')
