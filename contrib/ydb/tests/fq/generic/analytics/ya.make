...
DATA(arcadia/contrib/ydb/library/yql/providers/generic/connector/tests/fq-connector-go)

INCLUDE(${ARCADIA_ROOT}/contrib/ydb/tests/tools/fq_runner/ydb_runner_with_datastreams.inc)

INCLUDE(${ARCADIA_ROOT}/contrib/ydb/tests/tools/mdb_mock/recipe.inc)

INCLUDE(${ARCADIA_ROOT}/contrib/ydb/tests/tools/token_accessor_mock/recipe.inc)
...
PEERDIR(
    ...
    contrib/ydb/tests/fq/generic/utils
