...
from contrib.ydb.public.api.client.yc_private.iam import iam_token_service_pb2
from contrib.ydb.public.api.client.yc_private.iam import iam_token_service_pb2_grpc
