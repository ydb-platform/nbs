...
def test(suite, case, cfg, solomon):
    ...
    kqprun = KqpRun(config_file=os.path.join('contrib/ydb/tests/fq/solomon/cfg', 'kqprun_config.conf'),
                    scheme_file=os.path.join('contrib/ydb/tests/fq/solomon/cfg', 'kqprun_scheme.sql'))
