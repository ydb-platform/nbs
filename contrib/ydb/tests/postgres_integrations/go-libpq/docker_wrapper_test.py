...
from contrib.ydb.tests.postgres_integrations import library as tl
...
tl.set_tests_folder(yatest.common.source_path("contrib/ydb/tests/postgres_integrations/go-libpq/data"))
