...
from contrib.ydb.tests.postgres_integrations.library import pytest_integration
from contrib.ydb.tests.postgres_integrations.library.pytest_integration import TestCase, TestState


TEST_DATA_FOLDER = yatest.common.source_path("contrib/ydb/tests/postgres_integrations/library/ut/data")
