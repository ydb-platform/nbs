...
from contrib.ydb.public.api.protos import ydb_config_pb2 as config_api
from contrib.ydb.public.api.protos import ydb_discovery_pb2
from contrib.ydb.public.api.protos.draft import ydb_dynamic_config_pb2 as dynconfig_api
