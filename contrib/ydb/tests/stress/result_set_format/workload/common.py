...
from contrib.ydb.tests.datashard.lib.types_of_variables import string_to_ydb_type

# Non-inclusive limits from: contrib/ydb/library/yql/public/udf/udf_data_type.h
MAX_DATE = 49673
