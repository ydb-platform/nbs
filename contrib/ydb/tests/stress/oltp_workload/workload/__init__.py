...
from contrib.ydb.tests.stress.oltp_workload.workload.type.fulltext_index import WorkloadFulltextIndex
from contrib.ydb.tests.stress.oltp_workload.workload.type.vector_index import WorkloadVectorIndex
from contrib.ydb.tests.stress.oltp_workload.workload.type.json_index import WorkloadJsonIndex
from contrib.ydb.tests.stress.oltp_workload.workload.type.insert_delete_all_types import WorkloadInsertDeleteAllTypes
from contrib.ydb.tests.stress.oltp_workload.workload.type.select_partition import WorkloadSelectPartition
from contrib.ydb.tests.stress.oltp_workload.workload.type.secondary_index import WorkloadSecondaryIndex
from contrib.ydb.tests.stress.oltp_workload.workload.type.bloom_filter_index import WorkloadBloomFilterIndex
from contrib.ydb.tests.stress.oltp_workload.workload.type.tli import WorkloadTli
