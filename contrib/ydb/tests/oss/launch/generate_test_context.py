...
test_context = {
    'runtime': {
        'build_root': '',
        'output_path': '',
        'project_path': 'contrib/ydb/tests/functional',
        'source_root': '',
        'work_path': 'contrib/ydb/tests/functional/test-results'
    }
}
...
if __name__ == '__main__':
    ...
    test_context['runtime']['output_path'] = os.path.join(
        args.source_root,
        'contrib/ydb/tests/functional/test-results/py3test/testing_out_stuff'
    )
    test_context['runtime']['source_root'] = args.source_root
    test_context['runtime']['work_path'] = os.path.join(
        args.source_root,
        'contrib/ydb/tests/functional/test-results/py3test'
    )
