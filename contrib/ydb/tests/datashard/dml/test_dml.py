...
class TestDMLBase(TestBase):
    def do_test_dml(self, table_name: str, pk_types: dict[str, str], all_types: dict[str, str], index: dict[str, str], ttl: str, unique: str, sync: str):
...
class TestDML(TestDMLBase):
    ...
    def test_dml(self, table_name: str, pk_types: dict[str, str], all_types: dict[str, str], index: dict[str, str], ttl: str, unique: str, sync: str):
        self.do_test_dml(table_name, pk_types, all_types, index, ttl, unique, sync)


class TestPgDML(TestPgBase, TestDMLBase):
    @pytest.mark.parametrize(
        "table_name, pk_types, all_types, index, ttl, unique, sync",
        [
