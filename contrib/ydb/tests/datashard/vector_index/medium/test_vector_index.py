...
from contrib.ydb.tests.datashard.lib.vector_index import get_vector, targets
...
from contrib.ydb.tests.datashard.lib.create_table import create_vector_index_sql_request
