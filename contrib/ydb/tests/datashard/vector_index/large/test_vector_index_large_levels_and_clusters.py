...
from contrib.ydb.tests.datashard.lib.vector_index import targets, to_binary_string_converters, VectorIndexOperations
from contrib.ydb.tests.datashard.lib.create_table import create_table_sql_request, create_vector_index_sql_request
