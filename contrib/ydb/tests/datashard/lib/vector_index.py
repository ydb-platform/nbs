from contrib.ydb.tests.sql.lib.test_query import Query

from contrib.ydb.tests.datashard.lib.types_of_variables import cleanup_type_name, format_sql_value
...
to_binary_string_converters = {
    ...
    "int8": BinaryStringConverter(
        name="Knn::ToBinaryStringInt8", data_type="Int8", vector_type="Int8Vector"
    ),
    "bit": BinaryStringConverter(
        name="Knn::ToBinaryStringBit", data_type="Float", vector_type="BitVector"
    ),
}
