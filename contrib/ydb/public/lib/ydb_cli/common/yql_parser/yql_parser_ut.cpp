#include <contrib/ydb/public/lib/ydb_cli/common/yql_parser/yql_parser.h>
...
Y_UNIT_TEST_SUITE(TYqlParamParserTest) {
    ...
    Y_UNIT_TEST(TestAllTypes) {
        TString jsonContent;
        TFileInput file(TStringBuilder() << ArcadiaSourceRoot() << "/contrib/ydb/library/yql/data/language/types.json");
