...
from contrib.ydb.tools.include_sanitizer.compdb.generate import (  # noqa: E402
    PATCH_MARKER_BEGIN,
    PATCH_MARKER_END,
    patch_clang_wrapper,
    patch_retry_cc,
...
class RecorderShimExecutionTest(unittest.TestCase):
    ...
    def test_shim_invokes_inline_analyze_when_requested(self) -> None:
        ...
        from contrib.ydb.tools.include_sanitizer.common import PATHS
    ...
    def test_clang_wrapper_subprocess_call_still_in_main(self) -> None:
        ...
        from contrib.ydb.tools.include_sanitizer.compdb.generate import patch_clang_wrapper
...
class DetectSelfBinaryTest(unittest.TestCase):
    ...
    def test_python_interpreter_is_not_a_binary(self) -> None:
        from contrib.ydb.tools.include_sanitizer.compdb import generate
...
class RepoRootDetectionTest(unittest.TestCase):
    ...
    def test_marker_only_arcadia_root(self) -> None:
        from contrib.ydb.tools.include_sanitizer.common import _find_marker_root
    ...
    def test_env_override_wins(self) -> None:
        from contrib.ydb.tools.include_sanitizer.common import _detect_repo_root
...
class BinaryShimTemplateTest(unittest.TestCase):
    def test_recorder_bin_bakes_binary_exec_shim(self) -> None:
        ...
        from contrib.ydb.tools.include_sanitizer.compdb.generate import _shim_block, SHIM_TEMPLATE_RETRY_CC_BIN
