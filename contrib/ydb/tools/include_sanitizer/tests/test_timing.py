...
from contrib.ydb.tools.include_sanitizer.timing.parse import parse_trace  # noqa: E402
from contrib.ydb.tools.include_sanitizer.timing.aggregate import (  # noqa: E402
    collect_traces,
    write_reports,
)
...
class ParseTraceTest(unittest.TestCase):
    ...
    def test_location_parser_handles_macro_spelling(self) -> None:
        from contrib.ydb.tools.include_sanitizer.timing.parse import _file_from_location
        # bare
        self.assertEqual(
