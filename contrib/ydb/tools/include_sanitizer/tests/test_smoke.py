...
from contrib.ydb.tools.include_sanitizer.aggregate.graph import (  # noqa: E402
...
from contrib.ydb.tools.include_sanitizer.analyze.source_includes import scan_includes  # noqa: E402
from contrib.ydb.tools.include_sanitizer.report.diff_preview import (  # noqa: E402
    render_header_diff,
...
class ClassifyTest(unittest.TestCase):
    ...
    def test_cycle_error_classified_distinctly(self) -> None:
        from contrib.ydb.tools.include_sanitizer.aggregate.graph import VERDICT_CYCLE, VERDICT_PROBE_FAILED
        files: Dict[str, dict] = {
            "cyc.h": {
                "kind": "header",
                "includes": [
    ...
    def test_move_to_cpp_resolves_relative_sibling_to_source_root(self) -> None:
        ...
        from contrib.ydb.tools.include_sanitizer.aggregate.graph import VERDICT_MOVE_TO_CPP
        files: Dict[str, dict] = {
            "ydb/a/synclog/h.h": {
                "kind": "header",
                "includes": [
...
class DiffPreviewTest(unittest.TestCase):
    ...
    def test_self_contained_file_edit_adds_and_removes(self) -> None:
        from contrib.ydb.tools.include_sanitizer.report.selfcontain import render_file_edit
        f = self.tmp / "T.cpp"
        f.write_text(
            '#include "keep.h"\n'
            '#include "dead.h"\n'
...
class HeaderProbePreambleTest(unittest.TestCase):
    ...
    def test_synthesize_probe_with_preamble_writes_preceding_includes(self) -> None:
        from contrib.ydb.tools.include_sanitizer.analyze.header_probe import synthesize_probe
    ...
    def test_tu_preamble_returns_includes_before_target(self) -> None:
        from contrib.ydb.tools.include_sanitizer.analyze.per_tu import _tu_preamble_for_header
        repo = self.tmp / "repo"
