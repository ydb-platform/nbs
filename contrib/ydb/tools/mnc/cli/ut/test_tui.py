...
from contrib.ydb.tools.mnc.cli import arg_metadata, command_options, parser_factory
from contrib.ydb.tools.mnc.cli.tui import app as tui_app
from contrib.ydb.tools.mnc.cli.tui.app import TuiApp
from contrib.ydb.tools.mnc.cli.tui.command_picker import CommandPickerApp, _BackListItem
from contrib.ydb.tools.mnc.cli.tui.common import ConfigCandidate, config_preview
from contrib.ydb.tools.mnc.cli.tui.launcher import LauncherResult, TuiLauncher, should_route_to_launcher
from contrib.ydb.tools.mnc.lib import output
from contrib.ydb.tools.mnc.lib.output import VerbosityMode
from contrib.ydb.tools.mnc.lib.progress_live import LiveBackend
...
class TuiLauncherRoutingTest(unittest.TestCase):
    ...
    def test_textual_apps_use_consistent_light_theme_friendly_panel_css(self):
        from contrib.ydb.tools.mnc.cli.tui.app import RuntimeProgressApp
        from contrib.ydb.tools.mnc.cli.tui.config_picker import ConfigPickerApp
        from contrib.ydb.tools.mnc.cli.tui.options_form import OptionsFormApp
