...
from contrib.ydb.tools.mnc.cli import command_options
from contrib.ydb.tools.mnc.cli import main
from contrib.ydb.tools.mnc.cli import parser_factory
from contrib.ydb.tools.mnc.lib import progress
from contrib.ydb.tools.mnc.lib.exceptions import CliError
from contrib.ydb.tools.mnc.lib.output import VerbosityMode
...
class CliMainTest(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        import contrib.ydb.tools.mnc.lib.output as output_module
