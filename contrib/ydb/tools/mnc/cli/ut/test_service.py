...
from contrib.ydb.tools.mnc.cli.ut.helpers import ParentTask
from contrib.ydb.tools.mnc.lib import service
    ...
    async def test_act_hosts_aggregates_results_across_hosts(self):
        ...
        async def one_host(command, host, node_type=None, force=False, parent_task=None, subtasks=None):
            ...
            if subtasks is not None:
                ...
                from contrib.ydb.tools.mnc.cli.ut.helpers import Task as _Task
