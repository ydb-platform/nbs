...
from contrib.ydb.tools.mnc.cli import arg_metadata, command_options
from contrib.ydb.tools.mnc.cli.tui.command_picker import CommandPickerApp
from contrib.ydb.tools.mnc.cli.tui.common import (
    COMMON_OPTION_GROUP,
