...
from contrib.ydb.tools.mnc.viewer.styles.cluster_config import CLUSTER_CONFIG_CSS
...
from contrib.ydb.tools.mnc.viewer.widgets.modals import ConfigNameModal, MessageModal
