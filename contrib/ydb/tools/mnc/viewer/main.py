...
from contrib.ydb.tools.mnc.cli.commands import install as install_command
from contrib.ydb.tools.mnc.cli.commands import uninstall as uninstall_command
from contrib.ydb.tools.mnc.lib import agent_client, deploy_ctx, output as mnc_output
from contrib.ydb.tools.mnc.lib.progress_live import LiveBackend
from contrib.ydb.tools.mnc.scheme import common as scheme_common
from contrib.ydb.tools.mnc.viewer.commands import OperationsCommands, TabCommands, ViewerCommands
