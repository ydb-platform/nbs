...
from contrib.ydb.tools.mnc.viewer.widgets.config_models import ConfigCandidate, SelectedClusterConfig
from contrib.ydb.tools.mnc.viewer.widgets.operation_models import OperationState
