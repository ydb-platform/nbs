...
from contrib.ydb.tools.mnc.agent.schemas.disk import DiskDeviceSchema, DiskOperationItemSchema, DiskOperationRequest, DiskOperationResponse
...
from contrib.ydb.tools.mnc.agent.services import operations
