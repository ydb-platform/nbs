...
from contrib.ydb.tools.mnc.agent.services import database as database_module
from contrib.ydb.tools.mnc.agent.services.database import DatabaseService
from contrib.ydb.tools.mnc.agent.services.nodes import NodeServicePersistent
