...
from contrib.ydb.tools.mnc.agent.services import nodes
from contrib.ydb.tools.mnc.lib import term
...
class NodeInstallTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_install_nodes_rejects_when_nodes_exist(self):
        service = self.make_service()
        from contrib.ydb.tools.mnc.agent.schemas.node import NodesResponseSchema, NodeStatusSchema
    ...
    async def test_install_nodes_creates_static_and_dynamic_configs(self):
        service = self.make_service()
        from contrib.ydb.tools.mnc.agent.schemas.node import NodesResponseSchema
