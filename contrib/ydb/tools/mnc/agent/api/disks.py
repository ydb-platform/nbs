...
from contrib.ydb.tools.mnc.agent.schemas.disk import DiskCheckRequest, DiskInfoRequest, DiskOperationRequest
...
from contrib.ydb.tools.mnc.agent.services.operations import DiskOperationTask
