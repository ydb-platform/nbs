...
from contrib.ydb.tools.mnc.agent import config
from contrib.ydb.tools.mnc.agent.api.disks import routes as disks_routes
from contrib.ydb.tools.mnc.agent.api.errors import error_middleware
from contrib.ydb.tools.mnc.agent.api.health import routes as health_routes
from contrib.ydb.tools.mnc.agent.api.nodes import routes as nodes_routes
from contrib.ydb.tools.mnc.agent.api.tasks import routes as tasks_routes
from contrib.ydb.tools.mnc.agent.services.database import database_service
from contrib.ydb.tools.mnc.agent.services.tasks import task_service
