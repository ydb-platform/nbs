...
from contrib.ydb.core.protos import grpc_pb2_grpc
from contrib.ydb.core.protos import msgbus_pb2
from contrib.ydb.core.protos import console_config_pb2
from contrib.ydb.public.api.protos import ydb_status_codes_pb2
