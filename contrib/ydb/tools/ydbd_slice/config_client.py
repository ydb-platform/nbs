...
from contrib.ydb.public.api.grpc import ydb_config_v1_pb2_grpc as grpc_server
from contrib.ydb.public.api.protos import ydb_config_pb2 as config_api
from contrib.ydb.public.api.protos import ydb_status_codes_pb2 as ydb_status_codes
