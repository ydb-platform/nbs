...
def post_install(self):
    ...
    OPENSOURCE_EXPORT_REPLACEMENT(
        ...
        CONAN protobuf/${OPENSOURCE_REPLACE_PROTOBUF} "&& conan-requires" protobuf/${OPENSOURCE_REPLACE_PROTOBUF}
...
""",
        ...
        fileutil.copy(
            os.path.join(self.arcdir, "src/google/protobuf/compiler/perlxs"),
            os.path.join(libprotoc_abs_dir, "src/google/protobuf/compiler/"),
        )
