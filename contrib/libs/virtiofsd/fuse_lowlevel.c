...
#define LL_SET_DEFAULT(cond, cap)             \
    ...
    fuse_log(FUSE_LOG_ERR, "   INIT: %u.%u\n", outarg.major, outarg.minor);
    fuse_log(FUSE_LOG_ERR, "   flags=0x%08x\n", outarg.flags);
    fuse_log(FUSE_LOG_ERR, "   max_readahead=0x%08x\n", outarg.max_readahead);
    fuse_log(FUSE_LOG_ERR, "   max_write=0x%08x\n", outarg.max_write);
    fuse_log(FUSE_LOG_ERR, "   max_background=%i\n", outarg.max_background);
    fuse_log(FUSE_LOG_ERR, "   congestion_threshold=%i\n",
             outarg.congestion_threshold);
    fuse_log(FUSE_LOG_ERR, "   time_gran=%u\n", outarg.time_gran);
