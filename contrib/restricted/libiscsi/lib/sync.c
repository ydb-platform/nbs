...
#ifdef AROS
#error #include "aros/aros_compat.h"
#endif

#if defined(_WIN32)
#include <winsock2.h>
#error #include "win32/win32_compat.h"
#endif
 ...
 */
static void
iscsi_sync_cb(struct iscsi_context *iscsi __attribute__((unused)), int status,
	      void *command_data __attribute__((unused)), void *private_data)
{
 ...
 */
static void
scsi_sync_cb(struct iscsi_context *iscsi __attribute__((unused)), int status, void *command_data,
	     void *private_data)
{
...
void iscsi_free_discovery_data(struct iscsi_context *iscsi __attribute__((unused)),
...
static void
iscsi_discovery_cb(struct iscsi_context *iscsi __attribute__((unused)), int status,
	      void *command_data, void *private_data)
{
	struct iscsi_sync_state *state = private_data;
        struct iscsi_discovery_address *da;
