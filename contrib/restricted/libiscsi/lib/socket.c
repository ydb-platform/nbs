...
int iscsi_set_tcp_keepalive(struct iscsi_context *iscsi, int idle __attribute__((unused)), int count __attribute__((unused)), int interval __attribute__((unused)))
{
#ifdef SO_KEEPALIVE
	int value = 1;
...
void iscsi_set_bind_interfaces(struct iscsi_context *iscsi, char * interfaces __attribute__((unused)))
{
#if __linux
