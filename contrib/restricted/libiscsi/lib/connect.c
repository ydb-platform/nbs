...
static void
iscsi_connect_cb(struct iscsi_context *iscsi, int status, void *command_data __attribute__((unused)),
		 void *private_data);
...
static void
iscsi_login_cb(struct iscsi_context *iscsi, int status, void *command_data __attribute__((unused)),
	       void *private_data)
{
	struct connect_task *ct = private_data;
...
void iscsi_reconnect_cb(struct iscsi_context *iscsi __attribute__((unused)), int status,
                        void *command_data __attribute__((unused)), void *private_data __attribute__((unused)))
{
