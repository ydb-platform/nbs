                ...
                OrderedDict(
                    sorted(
                        [
                            ...
                            # Make configure happy, see YMAKE-218
                            (
                                "ARCH_RISCV32 AND OS_NONE",
                                Linkable(
                                    ADDINCL=[
                                        configs_dir + "/x86_64-pc-linux-gnu",
                                        GLOBAL(configs_dir + "/x86_64-pc-linux-gnu/include"),
                            ...
                            (
                                # fix only configure-stage for ARCH_ARM7EM
                                "ARCH_ARM7EM AND OS_NONE",
                                Linkable(
                                    ADDINCL=[
                                        configs_dir + "/x86_64-pc-linux-gnu",
                                        GLOBAL(configs_dir + "/x86_64-pc-linux-gnu/include"),
                            ...
                            (
                                # fix only configure-stage for ARCH_ARM8M
                                "ARCH_ARM8M AND OS_NONE",
                                Linkable(
                                    ADDINCL=[
                                        configs_dir + "/x86_64-pc-linux-gnu",
                                        GLOBAL(configs_dir + "/x86_64-pc-linux-gnu/include"),
