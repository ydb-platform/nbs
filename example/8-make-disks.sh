...
./blockstore-client.sh CreateVolume --disk-id=nrd1 --storage-media-kind nonreplicated --blocks-count=262144 --block-size=4096 --cloud-id=cloud --folder-id=folder --placement-group-id=pg-spread
./blockstore-client.sh CreateVolume --disk-id=nrd2 --storage-media-kind nonreplicated --blocks-count=262144 --block-size=8192 --cloud-id=cloud --folder-id=folder --placement-group-id=pg-part --placement-partition-index=1
...
./blockstore-client.sh CreateVolume --disk-id=lcl1 --storage-media-kind local --blocks-count=262144 --cloud-id=cloud --folder-id=folder
./blockstore-client.sh CreateVolume --disk-id=lcl2 --storage-media-kind local --blocks-count=262144 --cloud-id=cloud --folder-id=folder --encryption-mode=aes-xts --encryption-key-path=encryption-key.txt
