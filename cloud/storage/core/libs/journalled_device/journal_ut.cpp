...
Y_UNIT_TEST_SUITE(TJournalTest)
{
    ...
    Y_UNIT_TEST_F(ShouldReportAnAlreadyIndexedLsn, TFixture)
    {
        ...
        UNIT_ASSERT_VALUES_EQUAL(S_ALREADY, WriteRecord(3, 2, 'X', {{30, 1}}));
        UNIT_ASSERT_VALUES_EQUAL(S_ALREADY, WriteRecord(1, 0, 'X', {{10, 1}}));
    ...
    Y_UNIT_TEST_F(
        ShouldNotAdvanceTheLastAckedLsnWhenTheMetaStoreFails,
        TFixture)
    {
        UNIT_ASSERT_VALUES_EQUAL(0, RestoreOrFail());
