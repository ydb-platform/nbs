...
[[nodiscard]] TFuture<NCloud::NProto::TError> TJournal::Restore()
{
...
[[nodiscard]] TFuture<NCloud::NProto::TError> TJournal::Write(
    const NCloud::NProto::TWriteLogRecordRequest& request)
{
...
[[nodiscard]] auto TJournal::ReadTail(
    ui64 afterLsn,
...
[[nodiscard]] auto TJournal::AdvanceLastAckedLsn(ui64 lastAckedLsn)
...
[[nodiscard]] auto TJournal::GetFirstRecordToFlush() const
