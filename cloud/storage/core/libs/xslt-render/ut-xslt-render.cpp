...
Y_UNIT_TEST_SUITE(XsltRenderTest) {
    Y_UNIT_TEST(ShouldRenderXslt) {
        ...
        NXml::TDocument document(NResource::Find("xslt-render/ut/xml1"), NXml::TDocument::String);
        TStringStream result;
        renderer.Render(document, result);
        UNIT_ASSERT_VALUES_EQUAL(result.Str(), NResource::Find("xslt-render/ut/result1"));
    }
