...
def start(argv):
    ...
    new_root_fs_image = prepare_root_image(rootfs, yatest.common.output_path())
    ...
    cmd = [
        ...
        "-nographic",
        "-drive", "format=qcow2,file={},id=hdd0,if=none,aio=native,cache=none".format(new_root_fs_image),
