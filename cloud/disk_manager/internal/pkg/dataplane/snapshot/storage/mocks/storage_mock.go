...
func (s *StorageMock) SetBackupSlave(
	ctx context.Context,
	snapshotID string,
	slave string,
) error {

	args := s.Called(ctx, snapshotID, slave)
	return args.Error(0)
}
...
func (s *StorageMock) EnqueueBackupDeleting(
	ctx context.Context,
	entries []storage.BackupDeletingEntry,
) error {
...
func (s *StorageMock) GetBackupDeleting(
	ctx context.Context,
	limit int,
) ([]storage.BackupDeletingEntry, error) {

	args := s.Called(ctx, limit)
	return args.Get(0).([]storage.BackupDeletingEntry), args.Error(1)
}

func (s *StorageMock) ClearBackupDeleting(
	ctx context.Context,
	entries []storage.BackupDeletingEntry,
) error {
...
func (s *StorageMock) GetBackupDeletingLength(
	ctx context.Context,
) (uint64, error) {
