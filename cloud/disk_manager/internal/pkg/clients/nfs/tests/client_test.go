...
var unsafeCreateNodeFilesystem = nfs_testing.Root(
	nfs_testing.Dir("a",
		nfs_testing.Dir("a",
			...
			nfs_testing.Symlink("link", "/a/a/1"),
		),
		nfs_testing.Dir("b",
			nfs_testing.File("1"),
			nfs_testing.File("2"),
			...
			nfs_testing.Symlink("link", "/a/b/2"),
		),
		nfs_testing.Dir("c",
			nfs_testing.File("1"),
			nfs_testing.File("2"),
			...
			nfs_testing.Symlink("link", "/a/c/3"),
		),
		nfs_testing.File("1"),
		nfs_testing.File("2"),
		nfs_testing.File("3"),
		nfs_testing.Symlink("link", "/a/1"),
	),
	nfs_testing.Dir("b",
		nfs_testing.Dir("a",
			nfs_testing.File("1"),
			nfs_testing.File("2"),
			nfs_testing.File("3"),
			nfs_testing.Symlink("link", "/b/a/1"),
		),
		nfs_testing.Dir("b",
			nfs_testing.File("1"),
			nfs_testing.File("2"),
			nfs_testing.File("3"),
			nfs_testing.Symlink("link", "/b/b/2"),
		),
		nfs_testing.Dir("c",
			nfs_testing.File("1"),
			nfs_testing.File("2"),
			nfs_testing.File("3"),
			nfs_testing.Symlink("link", "/b/c/3"),
		),
		nfs_testing.File("1"),
		nfs_testing.File("2"),
		nfs_testing.File("3"),
		nfs_testing.Symlink("link", "/b/1"),
	),
	nfs_testing.Dir("c",
		nfs_testing.Dir("a",
			nfs_testing.File("1"),
			nfs_testing.File("2"),
			nfs_testing.File("3"),
			nfs_testing.Symlink("link", "/c/a/1"),
		),
		nfs_testing.Dir("b",
			nfs_testing.File("1"),
			nfs_testing.File("2"),
			nfs_testing.File("3"),
			nfs_testing.Symlink("link", "/c/b/2"),
		),
		nfs_testing.Dir("c",
			nfs_testing.File("1"),
			nfs_testing.File("2"),
			nfs_testing.File("3"),
			nfs_testing.Symlink("link", "/c/c/3"),
		),
		nfs_testing.File("1"),
		nfs_testing.File("2"),
		nfs_testing.File("3"),
		nfs_testing.Symlink("link", "/c/1"),
	),
	nfs_testing.File("1"),
	nfs_testing.File("2"),
	nfs_testing.File("3"),
	nfs_testing.BlockDev("dev", 1),
	nfs_testing.Symlink("link", "/1"),
)
