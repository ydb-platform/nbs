...
import (
	...
	filesystemsnapshots "github.com/ydb-platform/nbs/cloud/disk_manager/internal/pkg/services/filesystem_snapshots"
)
...
func assertServiceMockIsService(arg *ServiceMock) filesystemsnapshots.Service {
	return arg
}
