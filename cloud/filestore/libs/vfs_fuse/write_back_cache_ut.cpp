...
Y_UNIT_TEST_SUITE(TWriteBackCacheTest)
{
    ...
    Y_UNIT_TEST(ShouldMergeRequestsWhenFlushing)
    {
        ...
        b.WriteToCache(1, 0, "aa");
        b.WriteToCache(1, 1, "bbb");
        b.WriteToCache(1, 2, "cccc");
        b.WriteToCache(1, 3, "ddddd");
        b.WriteToCache(1, 4, "eeeeee");
    ...
    void TestShouldReadAfterWriteConcurrently(bool withFlush = false)
    {
        TBootstrap b;
