...
struct TBootstrap
{
    ...
    void ValidateCache(ui64 handle, ui64 offset, const TString& expected)
    {
    ...
    {
        auto expected = TStringBuf(ExpectedData[handle])
            .SubString(offset, length);

        ValidateCache(handle, offset, TString(expected));
    }
