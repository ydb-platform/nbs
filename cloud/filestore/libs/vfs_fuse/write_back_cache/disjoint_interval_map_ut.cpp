...
TString Dump(const TDisjointIntervalMap<TKey, TValue> map)
{
    TStringBuilder sb;
    sb << "[";
...
Y_UNIT_TEST_SUITE(TDisjointIntervalMapTest)
{
    Y_UNIT_TEST(SimpleAdd)
    {
        ...
        UNIT_ASSERT_VALUES_EQUAL("[(1, 3): vasya, (3, 5): petya]", Dump(map));
    }
