...
public:
    ...
    bool HasUnflushedRequests() const
    {
        ...
        return Storage.HasUnflushedRequests();
    }
    ...
    TPin PinCachedData(ui64 nodeId)
    {
        ...
        const ui64 sequenceId = nodeState.GetMinUnflushedSequenceId();
    ...
    TPin PinAllCachedData()
    {
        ...
        const ui64 sequenceId = Storage.GetMinUnflushedSequenceId();
        ...
        if (includePendingRequests) {
            ...
            State.FlushAllSequenceId =
                Max(State.FlushAllSequenceId,
                    Storage.GetMaxUnflushedCachedSequenceId());
        }
...
{
    return Impl->HasUnflushedRequests();
}
