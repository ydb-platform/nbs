...
struct TBootstrap
{
    ...
    TBootstrap()
        ...
        , Storage(Stats)
        , RequestStorage(SequenceIdGenerator, Storage, *Timer, Stats)
    {}
...
Y_UNIT_TEST_SUITE(TPersistentRequestStorageTest)
{
    Y_UNIT_TEST(Add_SetFlushed_Evict)
    {
        ...
        UNIT_ASSERT(!b.RequestStorage.HasPendingOrUnflushedRequests());
        UNIT_ASSERT_VALUES_EQUAL(
            Max<ui64>(),
            b.RequestStorage.GetMinPendingOrUnflushedSequenceId());
