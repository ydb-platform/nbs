...
#define TRACE_RDMA_REQUEST_STATE_NEED_ACCEL_TASK			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_RDMA, 0x13)
...
/* fsdev tracepoint definitions */
#define TRACE_FSDEV_IO_START		SPDK_TPOINT_ID(TRACE_GROUP_FSDEV, 0x0)
#define TRACE_FSDEV_IO_DONE		SPDK_TPOINT_ID(TRACE_GROUP_FSDEV, 0x1)
