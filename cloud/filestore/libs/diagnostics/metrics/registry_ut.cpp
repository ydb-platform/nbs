...
////////////////////////////////////////////////////////////////////////////////
    ...
    Y_UNIT_TEST_F(ShouldMultipleRegisterUnregister, TEnv)
    {
        ...
        const auto firstKey = Registry->Register(
            {CreateSensor("first_sensor")},
            firstValue);

        std::atomic<i64> secondValue(322);
        const auto secondKey = Registry->Register(
            {CreateLabel("test_name", "test_value"), CreateSensor("second_sensor")},
            secondValue);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    Y_UNIT_TEST_F(ShouldNotFailOnBaseRegistryDestruction, TEnv)
    {
        ...
        scopedBaseRegistry->Register(
            {CreateSensor("test_sensor_2")},
            second);
