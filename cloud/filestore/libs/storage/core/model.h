...
//
// Max<ui16>() itself (the highest representable shard number) is reserved
// for the control namespace's synthetic inos - see
// service_actor_control_namespace.h - and is never assignable to a real
// shard.
