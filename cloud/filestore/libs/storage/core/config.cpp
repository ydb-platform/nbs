...
#define FILESTORE_STORAGE_CONFIG(xxx)                                          \
    ...
    xxx(InMemoryIndexCacheNodeRefsExhaustivenessCapacity, ui64, 0)             \
    ...
    xxx(GuestCachingType, NProto::EGuestCachingType, NProto::GCT_NONE)         \
...
IOutputStream& operator<<(IOutputStream& out, NProto::EGuestCachingType gct)
{
    ...
    {                                                         \
        ...
        if (!IsEmpty##name(ProtoConfig, value)) {             \
            TABLER () {                                       \
                ...
                TABLED () {                                   \
                    DumpImpl(ConvertValue<type>(value), out); \
                }                                             \
            }                                                 \
        }                                                     \
    }                                                         \
