...
// Returns MaxCommitId and blocksProcessed
ui64 FindDeletionMarker(
    const TByteVector& encodedDeletionMarkers,
    ui16 blobOffset,
    ui32 blocksToProcess,
    ui32* blocksProcessed)
{
    TBinaryReader reader(encodedDeletionMarkers);
