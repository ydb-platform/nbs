...
struct TIndexTabletSchema: public NKikimr::NIceDb::Schema
{
    enum EChannels
    {
        SystemChannel,
    ...
    struct FileSystem: TTableSchema<1>
    {
        ...
        struct LastCollectCommitId
            : Column<5, NKikimr::NScheme::NTypeIds::Uint64>
        {
        };
        ...
        struct DeletionMarkersCount
            : Column<13, NKikimr::NScheme::NTypeIds::Uint64>
        {
        };
        struct GarbageQueueSize: Column<14, NKikimr::NScheme::NTypeIds::Uint64>
        {
        };
        struct GarbageBlocksCount
            : Column<15, NKikimr::NScheme::NTypeIds::Uint64>
        {
        };
        struct CheckpointNodesCount
            : Column<16, NKikimr::NScheme::NTypeIds::Uint64>
        {
        };
        struct CheckpointBlocksCount
            : Column<17, NKikimr::NScheme::NTypeIds::Uint64>
        {
        };
        struct CheckpointBlobsCount
            : Column<18, NKikimr::NScheme::NTypeIds::Uint64>
        {
        };
        ...
        struct AttrsUsedBytesCount
            : Column<22, NKikimr::NScheme::NTypeIds::Uint64>
        {
        };
    ...
    struct Nodes: TTableSchema<5>
    {
        ...
        using TColumns = TableColumns<NodeId, CommitId, Proto>;
    ...
    struct Nodes_Ver: TTableSchema<6>
    {
        ...
        using TColumns = TableColumns<NodeId, MinCommitId, MaxCommitId, Proto>;
    ...
    struct NodeAttrs: TTableSchema<7>
    {
        ...
        using TColumns = TableColumns<NodeId, CommitId, Name, Value, Version>;
    ...
    struct MixedBlocks: TTableSchema<12>
    {
        ...
        struct Blocks: Column<4, NKikimr::NScheme::NTypeIds::String>
        {
            using Type = TStringBuf;
        };
        struct DeletionMarkers: Column<5, NKikimr::NScheme::NTypeIds::String>
        {
            using Type = TStringBuf;
        };
        ...
        struct CheckpointBlocksCount
            : Column<7, NKikimr::NScheme::NTypeIds::Uint32>
        {
        };
    ...
    struct DeletionMarkers: TTableSchema<13>
    {
        ...
        using TColumns =
            TableColumns<RangeId, NodeId, CommitId, BlockIndex, BlocksCount>;
    ...
    struct CheckpointBlobs: TTableSchema<18>
    {
        ...
        using TKey =
            TableKey<CheckpointId, RangeId, BlobCommitId, BlobUniqueId>;

        using TColumns =
            TableColumns<CheckpointId, RangeId, BlobCommitId, BlobUniqueId>;
    ...
    struct FreshBytes: TTableSchema<19>
    {
        ...
        using TColumns = TableColumns<MinCommitId, NodeId, Offset, Data, Len>;
    ...
    struct SessionDupCache: TTableSchema<21>
    {
        ...
        using TColumns = TableColumns<SessionId, EntryId, Proto>;
    ...
    struct TabletStorageInfo: TTableSchema<22>
    {
        ...
        using TColumns = TableColumns<Id, Proto>;
    ...
    struct LargeDeletionMarkers: TTableSchema<26>
    {
        ...
        using TColumns =
            TableColumns<NodeId, CommitId, BlockIndex, BlocksCount>;
