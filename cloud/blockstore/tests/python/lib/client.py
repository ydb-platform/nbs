...
class NbsClient:
    ...
    def backup_disk_registry_state(self, source=EBackupDiskRegistryStateSource.BACKUP_DISK_REGISTRY_STATE_SOURCE_LOCAL_DB):
        req = {"Source": source}
    ...
    def compare_disk_registry_state_with_db(self, timeout=300):
        ...
        resp = self.__execute_action("diskregistrycomparestate", req, timeout)
