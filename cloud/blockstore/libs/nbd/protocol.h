...
enum {
    ...
    NBD_CMD_FLAG_REQ_ONE    = 1 << 3, // only one extent in BLOCK_STATUS reply chunk
};
...
public:
    ...
    void WriteStructuredReadData(ui64 handle, ui64 offset, ui32 length, bool final);
    void WriteStructuredReadHole(ui64 handle, ui64 offset, ui32 length, bool final);
...
public:
    ...
    size_t ReadStructuredReplyData(TStructuredReply& reply, const TSgList& data);
};

////////////////////////////////////////////////////////////////////////////////

class TBufferRequestWriter
    : public TRequestWriter
{
private:
    TBufferOutput Out;
...
class TBufferRequestReader
    : public TRequestReader
{
private:
    TBufferInput In;
