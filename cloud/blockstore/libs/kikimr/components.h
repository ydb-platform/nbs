...
#define BLOCKSTORE_DECLARE_COMPONENT(component) \
    component,   // BLOCKSTORE_DECLARE_COMPONENT
...
#define BLOCKSTORE_DECLARE_COMPONENT(component) \
    component##_START,                          \
        component##_END =                       \
            component##_START + 100,   // BLOCKSTORE_DECLARE_COMPONENT
...
#undef BLOCKSTORE_DECLARE_COMPONENT
    ...
    static_assert(
        END < EventSpaceEnd(NKikimr::TKikimrEvents::ES_BLOCKSTORE),
        "END expected to be < "
        "EventSpaceEnd(NKikimr::TKikimrEvents::BLOCKSTORE)");

    // reserved for SchemeShard integration
    static_assert(
        SCHEMESHARD_START == START + 1011,
...
#undef BLOCKSTORE_DECLARE_COMPONENT
    ...
    static_assert(
        END < EventSpaceEnd(NKikimr::TKikimrEvents::ES_BLOCKSTORE_PRIVATE),
        "END expected to be < "
        "EventSpaceEnd(NKikimr::TKikimrEvents::BLOCKSTORE)");
};
