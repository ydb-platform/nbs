...
public:
    ...
    CreateRegisterBackgroundBandwidthSourceRequest(
        TString sourceId,
        ui32 bandwidth)
    {
...
// CHECK_STATS
    ...
    Y_UNIT_TEST(ShouldRegisterBackgroundBandwidthSources)
    {
        NProto::TStorageServiceConfig storageServiceConfig;
        ...
        auto response = client.RegisterBackgroundBandwidthSource("src1", 200);
        ...
        response = client.RegisterBackgroundBandwidthSource("src2", 600);
        ...
        response = client.RegisterBackgroundBandwidthSource("src1", 200);
