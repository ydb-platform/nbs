...
struct TTestBlockVisitor final: public IBlocksIndexVisitor
{
...
struct TTestBlockVisitorWithBlobOffset final: public IExtendedBlocksIndexVisitor
{
    TStringBuilder Result;
...
struct TTestBlobVisitor final: public IBlobsIndexVisitor
{
    ui64 ReadCount = 0;
...
Y_UNIT_TEST_SUITE(TPartitionDatabaseTest)
{
    ...
    Y_UNIT_TEST(ShouldFindRangeOfMixedBlocks)
    {
        ...
        executor.WriteTx(
            [&](TPartitionDatabase db)
            { db.WriteMixedBlocks(executor.MakeBlobId(), {0, 1, 2}); });

        executor.WriteTx(
            [&](TPartitionDatabase db)
            { db.WriteMixedBlocks(executor.MakeBlobId(), {4, 5, 6}); });

        ui64 maxCommitId = executor.WriteTx(
            [&](TPartitionDatabase db)
            { db.WriteMixedBlocks(executor.MakeBlobId(), {2, 3, 4}); });
        ...
        executor.ReadTx(
            [&](TPartitionDatabase db)
            {
                ...
                }
                {
                    ...
                    UNIT_ASSERT_VALUES_EQUAL(
                        visitor.Result,
                        "#1:5 #1:2 #2:5 #2:4 #2:2 #3:5 #3:4 #4:5 #4:4 #4:3 "
                        "#5:5 #5:3");
                }
            });
    }
        ...
        executor.ReadTx(
            [&](TPartitionDatabase db)
            {
                ...
                }
                {
                    TTestBlockVisitor visitor;
                    UNIT_ASSERT(
                        db.FindMixedBlocks(visitor, TVector<ui32>{1, 3, 5}));
                    UNIT_ASSERT_VALUES_EQUAL(
                        visitor.Result,
                        "#1:5 #1:2 #3:5 #3:4 #5:5 #5:3");
                }
            });
    }
        ...
        executor.ReadTx(
            [&](TPartitionDatabase db)
            {
                ...
                }
                {
                    ...
                    UNIT_ASSERT_VALUES_EQUAL(
                        visitor.Result,
                        "#1:2 #2:2 #2:4 #3:4 #4:4 #1:5 #2:5 #3:5 #4:5 #5:5 "
                        "#4:3 #5:3");
                }
            });
    }
    ...
    Y_UNIT_TEST(ShouldFindBlobsInBlobsIndex)
    {
        ...
        auto minCommitId = executor.WriteTx(
            [&](TPartitionDatabase db)
            {
                ...
                db.WriteBlobMeta(executor.MakeBlobId(), blobMeta);
            });
    ...
    Y_UNIT_TEST(ShouldCorrectlyDeleteCheckpoint)
    {
        ...
        executor.WriteTx(
            [&](TPartitionDatabase db)
            {
                TCheckpoint checkpoint("checkpoint", 42, "", Now(), {});
        ...
        executor.ReadTx(
            [&](TPartitionDatabase db)
            {
                ...
                UNIT_ASSERT_VALUES_EQUAL(
                    42,
                    checkpointId2CommitId["checkpoint"]);
            });
    ...
    Y_UNIT_TEST(ShouldFindBlobsInBlobIndex)
    {
        ...
        executor.WriteTx([&](TPartitionDatabase db)
                         { db.WriteBlobMeta(executor.MakeBlobId(), {}); });
        ...
        executor.WriteTx([&](TPartitionDatabase db)
                         { db.WriteBlobMeta(blobId, {}); });

        auto lastBlob = executor.MakeBlobId();
        executor.WriteTx([&](TPartitionDatabase db)
                         { db.WriteBlobMeta(lastBlob, {}); });
    ...
    Y_UNIT_TEST(ShouldUseSkipMaskInFindBlocksInBlobsIndex)
    {
        ...
        executor.ReadTx(
            [&](TPartitionDatabase db)
            {
                ...
                db.FindBlocksInBlobsIndex(visitor, MaxBlocksCount, blob1);

                UNIT_ASSERT_VALUES_EQUAL(
                    "#100:2:0 #101:2:1 #102:2:2 #103:2:3 #104:2:4 #105:2:5 "
                    "#106:2:6"
                    " #107:2:7 #108:x:65535 #109:x:65535 #110:x:65535 "
                    "#111:x:65535"
        ...
        executor.ReadTx(
            ...
            {
                TTestBlockVisitorWithBlobOffset visitor;
                db.FindBlocksInBlobsIndex(visitor, MaxBlocksCount, blob2);

                UNIT_ASSERT_VALUES_EQUAL(
                    "#110:3:0##111 #111:3:1##222 #112:3:2##333 #113:3:3 "
                    "#114:3:4"
                    ...
                    " #129:x:65535 #130:3:10 #131:3:11 #132:3:12 #133:3:13 "
                    "#134:3:14"
                    " #135:3:15 #136:3:16 #137:3:17 #138:3:18 #139:3:19 "
                    "#140:3:20",
                    visitor.Result);
            });
    }
