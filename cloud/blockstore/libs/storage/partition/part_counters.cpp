...
const char* const TPartitionCounters::SimpleCounterNames[] = {
    BLOCKSTORE_PARTITION_SIMPLE_COUNTERS(BLOCKSTORE_COUNTER_NAME)};

const char* const TPartitionCounters::CumulativeCounterNames[] = {
    BLOCKSTORE_PARTITION_CUMULATIVE_COUNTERS(BLOCKSTORE_COUNTER_NAME)};

const char* const TPartitionCounters::PercentileCounterNames[] = {
    BLOCKSTORE_PARTITION_PERCENTILE_COUNTERS(BLOCKSTORE_COUNTER_NAME)};

const char* const TPartitionCounters::TransactionTypeNames[] = {
    BLOCKSTORE_PARTITION_TRANSACTIONS(BLOCKSTORE_COUNTER_NAME, Tx)};
