...
{
public:
    enum class EMigrationConfPreparedType {
        NotPrepared,
        PreparedForFresh,
        PreparedForWarning,
    };
...
private:
    ...
    EMigrationConfPreparedType MigrationConfigPrepared =
        EMigrationConfPreparedType::NotPrepared;
...
public:
    ...
    EMigrationConfPreparedType GetTypeOfMigrationPreparedFor() {
