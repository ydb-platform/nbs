...
Y_UNIT_TEST_SUITE(TReplicaActorsTest)
{
    Y_UNIT_TEST(Test)
    {
        ...
        ASSERT_VECTORS_EQUAL(
            expectedVector,
            replicaActors.GetReplicaActorsBypassingProxies());
        ...
        UNIT_ASSERT_VALUES_EQUAL(
            laggingActor3,
            replicaActors.GetReplicaActor(2));
        UNIT_ASSERT_VALUES_EQUAL(
            2,
            replicaActors.GetReplicaIndex(laggingActor3));
        UNIT_ASSERT_VALUES_EQUAL(2, replicaActors.GetReplicaIndex(actor3));
        ...
        UNIT_ASSERT_VALUES_EQUAL(
            laggingActor1,
            replicaActors.GetReplicaActor(0));
        UNIT_ASSERT_VALUES_EQUAL(
            0,
            replicaActors.GetReplicaIndex(laggingActor1));
        UNIT_ASSERT_VALUES_EQUAL(0, replicaActors.GetReplicaIndex(actor1));
