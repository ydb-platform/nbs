...
class TTestBackend: public IDeviceServerBackend
{
private:
...
public:
    ...
    [[nodiscard]] auto ZeroDeviceBlocks(
        TInstant now,
        NProto::TZeroDeviceBlocksRequest request)
        -> TFuture<NProto::TZeroDeviceBlocksResponse> final
    {
        Y_UNUSED(now, request);

        return MakeFuture(NProto::TZeroDeviceBlocksResponse());
    }

    [[nodiscard]] auto ReadDeviceBlocks(
        TInstant now,
        NProto::TReadDeviceBlocksRequest request)
        -> TFuture<NProto::TReadDeviceBlocksResponse> final
    {
        Y_UNUSED(now, request);
    ...
    [[nodiscard]] auto WriteDeviceBlocks(
        TInstant now,
        NProto::TWriteDeviceBlocksRequest request)
        -> TFuture<NProto::TWriteDeviceBlocksResponse> final
    {
        Y_UNUSED(now, request);

        return MakeFuture(NProto::TWriteDeviceBlocksResponse());
    }
