...
// Enable ConfigsDispatcher when either DynamicYamlConfigurationEnabled
// from the static configuration or ConfigsDispatcherServiceEnabled from the
// startup configuration is enabled.
bool ShouldEnableConfigsDispatcher(
    const NServer::TServerAppConfig& staticServerConfig,
    const TStorageConfig& startupStorageConfig)
{
    return staticServerConfig.GetDynamicYamlConfigurationEnabled() ||
           startupStorageConfig.GetConfigsDispatcherServiceEnabled();
}
...
public:
        ...
        const TAppData* appData) override
    {
        ...
        auto blockstoreConfigHolder = InitializeBlockstoreConfigProvider(
            ...
            setup->LocalServices.emplace_back(
                ...
                TActorSetupCmd(
                    CreateConfigsManager({
                        .BlockstoreConfigHolder =
                            std::move(blockstoreConfigHolder),
                        .StaticConfig = Args.StaticBlockstoreConfigProto,
                        .InitialDynamicConfig =
                            Args.InitialDynamicBlockstoreConfig,
                        .InitialDynamicConfigPresent =
                            Args.InitialDynamicBlockstoreConfigPresent,
