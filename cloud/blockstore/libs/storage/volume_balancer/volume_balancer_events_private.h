...
struct TEvVolumeBalancerPrivate
{
    ...
    enum EEvents
    {
        ...
        BLOCKSTORE_VOLUME_BALANCER_REQUESTS_PRIVATE(BLOCKSTORE_DECLARE_EVENT_IDS)
    ...
    static_assert(EvEnd < (int)TBlockStorePrivateEvents::VOLUME_BALANCER_END,
    ...
    using TEvRemoteVolumeStats = TRequestEvent<TRemoteVolumeStats, EvRemoteVolumeStats>;
};
