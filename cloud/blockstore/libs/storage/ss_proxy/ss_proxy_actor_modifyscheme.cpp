...
//     void HandleTxDone(
//         const TEvStorageSSProxy::TEvWaitSchemeTxResponse::TPtr& ev,
//         const TActorContext& ctx);
...
//             NCloud::Send<TEvStorageSSProxy::TEvWaitSchemeTxRequest>(
//                 ctx,
//                 Owner,
//                 0,
//                 SchemeShardTabletId,
...
//     auto response = std::make_unique<sponse>(
//         error,
//         SchemeShardTabletId,
//         SchemeShardStatus,
//         SchemeShardReason);
...
//         HFunc(TEvStorageSSProxy::TEvWaitSchemeTxResponse, HandleTxDone);
