...
Y_UNIT_TEST_SUITE(TRequestsTimeTrackerTest)
{
    ...
    Y_UNIT_TEST(ShouldGetInflightRequestsInOrder)
    {
        TRequestsTimeTracker requestsTimeTracker(0);
        ...
        auto inflight = requestsTimeTracker.GetInflightOperations();
        ...
        UNIT_ASSERT_VALUES_EQUAL(
            TRequestsTimeTracker::ERequestType::Read,
            inflight[2].second.RequestType);

        auto stat = requestsTimeTracker.OnRequestFinished(
            2,
            true,
            2500 * GetCyclesPerMillisecond());
        UNIT_ASSERT_VALUES_EQUAL(
            TRequestsTimeTracker::ERequestType::Zero,
            stat->RequestType);
        inflight = requestsTimeTracker.GetInflightOperations();
