...
Y_UNIT_TEST_SUITE(TVolumeStateTest)
{
    ...
    Y_UNIT_TEST(FollowerDisks)
    {
        ...
        UNIT_ASSERT_VALUES_EQUAL("x", followers[0].Link.LinkUUID);
        ...
        UNIT_ASSERT_VALUES_EQUAL("y", followers[1].Link.LinkUUID);
        UNIT_ASSERT_VALUES_EQUAL("vol2", followers[1].Link.FollowerDiskId);

        // Remove link x by linkUUID
        volumeState.RemoveFollower(TLeaderFollowerLink{.LinkUUID = "x"});
        UNIT_ASSERT_VALUES_EQUAL(1, followers.size());
        UNIT_ASSERT_VALUES_EQUAL("y", followers[0].Link.LinkUUID);

        // Remove link y by leader and follower diskID
