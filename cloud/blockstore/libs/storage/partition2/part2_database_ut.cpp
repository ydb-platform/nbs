...
Y_UNIT_TEST_SUITE(TPartitionDatabaseTest)
{
    ...
    Y_UNIT_TEST(ShouldStoreBlobUpdates)
    {
        ...
        executor.WriteTx([&] (TPartitionDatabase db) {
            db.WriteGlobalBlobUpdate(1, 10, TBlockRange32::WithLength(0, 100));
            db.WriteGlobalBlobUpdate(2, 20, TBlockRange32::WithLength(50, 150));
            db.WriteZoneBlobUpdate(0, 3, 30, TBlockRange32::WithLength(0, 9));
            db.WriteZoneBlobUpdate(1, 4, 40, TBlockRange32::WithLength(100, 109));
            db.WriteZoneBlobUpdate(1, 5, 50, TBlockRange32::WithLength(110, 119));
        });
