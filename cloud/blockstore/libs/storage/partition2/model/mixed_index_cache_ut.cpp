...
template <>
inline void Out<NCloud::NBlockStore::NStorage::NPartition2::TMixedIndexCache::ERangeTemperature>(
    IOutputStream& out,
    NCloud::NBlockStore::NStorage::NPartition2::TMixedIndexCache::ERangeTemperature t)
{
    out << ToString(t);
}
