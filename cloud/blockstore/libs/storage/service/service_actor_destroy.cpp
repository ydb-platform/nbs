...
{
public:
    enum class EDiskIdSubstitution
    {
        Any,
        StrictName
    };
...
private:
    ...
    const EDiskIdSubstitution DiskIdSubstitution = EDiskIdSubstitution::Any;
...
public:
    TDestroyVolumeActor(
        ...
        TString diskId,
        EDiskIdSubstitution diskIdSubstitution,
...
TDestroyVolumeActor::TDestroyVolumeActor(
    ...
    , Timeout(timeout)
    , DiskIdSubstitution(diskIdSubstitution)
{}
    ...
    const TActorContext& ctx)
{
    ...
    if (msg->Record.GetVolume().GetDiskId() != DiskId) {
        switch (DiskIdSubstitution) {
            case EDiskIdSubstitution::Any: {
                LOG_WARN(
                    ctx,
                    TBlockStoreComponents::SERVICE,
            ...
            case EDiskIdSubstitution::StrictName: {
                ReplyAndDie(
                    ctx,
                    MakeError(
                        S_ALREADY,
    ...
    const TActorContext& ctx)
{
    ...
    auto diskIdSubstitution =
        request.GetUseStrictDiskId()
            ? TDestroyVolumeActor::EDiskIdSubstitution::StrictName
            : TDestroyVolumeActor::EDiskIdSubstitution::Any;
