    ...
    const TActorContext& ctx)
{
    ...
    using TFunc = TResultOrError<NActors::IActorPtr> (
        TServiceActor::*)(TRequestInfoPtr, TString);
    const THashMap<TString, TFunc> actions = {
        {"diskregistrysetwritablestate",
         &TServiceActor::CreateWritableStateActionActor},
        {"backupdiskregistrystate",
         &TServiceActor::CreateBackupDiskRegistryStateActor},
        ...
        {"configurevolumebalancer",
         &TServiceActor::CreateConfigureVolumeBalancerActionActor},
        {"deletecheckpointdata",
         &TServiceActor::CreateDeleteCheckpointDataActionActor},
        ...
        {"getdiskregistrytabletinfo",
         &TServiceActor::CreateGetDiskRegistryTabletInfo},
        {"creatediskfromdevices",
         &TServiceActor::CreateCreateDiskFromDevicesActionActor},
        ...
        {"changestorageconfig",
         &TServiceActor::CreateChangeStorageConfigActionActor},
        {"getnameservernodes",
         &TServiceActor::CreateGetNameserverNodesActionActor},
        ...
        {"backuppathdescriptions",
         &TServiceActor::CreateBackupPathDescriptionsActor},
        {"backuptabletbootinfos",
         &TServiceActor::CreateBackupTabletBootInfosActor},
    ...
    if (it == actions.end()) {
        ...
        auto result =
            std::invoke(actionFunc, this, requestInfo, std::move(input));
