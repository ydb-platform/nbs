...
func (s *mockBlockstoreServer) CheckRange(
	ctx context.Context,
	req *blockstore_protos.TCheckRangeRequest,
) (*blockstore_protos.TCheckRangeResponse, error) {

	args := s.Called(ctx, req)
	res, _ := args.Get(0).(*blockstore_protos.TCheckRangeResponse)
	return res, args.Error(1)
}
