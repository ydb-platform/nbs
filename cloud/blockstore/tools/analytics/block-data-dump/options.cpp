...
TOptions::TOptions(int argc, char** argv)
{
    ...
    opts.AddLongOption("bs")
        .RequiredArgument("NUM")
        .StoreResultDef(&BlockSize);

    opts.AddLongOption("count")
        .RequiredArgument("NUM")
        .StoreResultDef(&BlockCount);

    opts.AddLongOption("skip")
        .RequiredArgument("NUM")
        .StoreResultDef(&StartIndex);

    opts.AddLongOption("test-id")
        .RequiredArgument("NUM")
        .StoreResultDef(&TestId);
