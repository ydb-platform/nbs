...
#include <cloud/blockstore/tools/testing/eternal_tests/eternal-load/lib/aligned_direct_io_block_test_scenario.h>
    ...
    switch (Options->Scenario) {
        case EScenario::Block:
            settings.TestScenario =
                CreateAlignedDirectIoBlockTestScenario(ConfigHolder, log);
