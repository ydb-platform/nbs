...
* logical threads.
*
* Each thread is executed repeatedly. It should initiate one or several read or
* write requests via the provided context object. Next execution is made when
