...
func (s *TaskState) structValue() persistence.Value {
	return persistence.StructValue(
		...
		persistence.StructFieldValue("estimated_duration", persistence.IntervalValue(s.EstimatedDuration)),
...
func taskStateTableDescription() persistence.CreateTableDescription {
	return persistence.NewCreateTableDescription(
		...
		persistence.WithColumn("estimated_duration", persistence.Optional(persistence.TypeInterval)),
...
func (s *storageYDB) scanTaskState(res persistence.Result) (state TaskState, err error) {
	...
	err = res.ScanNamed(
		...
		persistence.OptionalWithDefault("estimated_duration", &state.EstimatedDuration),
